...
+function ($) {
    ...
    provider.list = {
        ...
        jqueryvalidation: {
            selector: 'jquery-validation',
            callback: 'initJqueryValidation',
            css: '',
            js:
            [
                'jquery-validation/jquery.validate.min.js',
                'jquery-validation/localization/messages_tr.min.js'
            ],
        },
...
+function ($) {
    ...
    provider.initJqueryValidation = function () {
    ...
    // Jquery Form
    //
    provider.initJqueryForm = function () {
