		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
                    monthContainerClass += ' pull-left col-xs-2 col-md-2 col-lg-2';
				}
				else if(monthSize * 4 < calendarSize) {
                    monthContainerClass += ' pull-left col-xs-3 col-md-3 col-lg-3';
				}
				else if(monthSize * 3 < calendarSize) {
                    monthContainerClass += ' pull-left col-xs-4 col-md-4 col-lg-4';
				}
				else if(monthSize * 2 < calendarSize) {
                    monthContainerClass += ' pull-left col-xs-6 col-md-6 col-lg-6';
				}
				else {
                    monthContainerClass += ' pull-left col-xs-12 col-md-12 col-lg-12';
				}
